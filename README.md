...
[Json-To-Java-Model Generator](https://rawgit.com/foobnix/android-universal-utils/master/json/generator.html)  
[Parcelable Generator](https://rawgit.com/foobnix/android-universal-utils/master/json/generator.html)  
**input JSON:**  
```json
{
  "dealerId": 1,
